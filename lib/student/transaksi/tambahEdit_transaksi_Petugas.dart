...
class TransaksiTambahEditP extends StatefulWidget {
  ...
  final index;
  TransaksiTambahEditP({this.index, this.transaksi});

  @override
  State<TransaksiTambahEditP> createState() => _TransaksiTambahEditPState();
}

class _TransaksiTambahEditPState extends State<TransaksiTambahEditP> {
